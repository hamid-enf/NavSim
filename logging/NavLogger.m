...
properties
    ...
    gnssP
    gnssV
    gnssFlag     % 1 = meas, 2 = outlier; NaN rows = no meas
    sigP
    sigV
...
methods
    ...
    function growIfNeeded(obj, idx)
        ...
        obj.gnssFlag = [obj.gnssFlag z1];
        obj.innovN = [obj.innovN z1];
