...
چارت‌های واقعی توضیح می‌دهد. فایل نهایی MP4 از طریق **GitHub Release** همین مخزن
(برچسب `video-1.0.0`) یا بازتولید از سورس در دسترس است؛ سورس کامل ساخت آن در
پوشه‌ی [`video/`](video/) قرار دارد.
